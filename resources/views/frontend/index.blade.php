                    ...
                    <div class="col-md-6">
                        ...
                        <div class="owl-init slider-main owl-carousel" data-items="1" data-nav="true" data-dots="false">
                            <div class="item-slide">
                                <img src="{{ asset('/img/frontend/banners/slide1.jpg') }}">
                            </div>
                    ...
                    <aside class="col-md-3">
                        ...
                        <div style="height:280px;">
                            <figure class="itemside has-bg border-bottom" style="height: 33%;">
                                <img class="img-bg" src="{{ asset('/img/frontend/items/item-sm.png') }}">
                    ...
                    <article href="#" class="card-banner h-100 bg2">
                        <div class="card-body zoom-wrap">
                            ...
                            <p>Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                aliqua. Lorem ipsum dolor sit amet, cLorem ipsum dolor sit amet, cLorem ipsum dolor sit
        ...
        <div class="row-sm">
            <div class="col-md-2">
                <figure class="card card-product">
                    <div class="img-wrap"> <img src="{{ asset('/img/frontend/items/3.jpg') }}"></div>
